...
> **CAUTION: Secret keys provide full access to any digital assets held in the wallet. Use `.env` files only for hot wallets in testnet deployments.**
> 
...
- [MPP Session Guide](channel-guide.md) — Set up off-chain payment channels for high-frequency payments
