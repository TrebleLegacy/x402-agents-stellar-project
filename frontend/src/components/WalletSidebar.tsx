    ...
    <div className="flex flex-col h-full bg-slate-950 p-6">
      ...
      <div className="mb-6 flex gap-2">
        <button 
          ...
          className="flex-[1] px-3 py-2 bg-slate-900 border border-slate-800 hover:bg-slate-800 rounded-lg text-[11px] font-semibold text-emerald-400 transition-colors flex items-center justify-center gap-1.5"
        >
        ...
        <button 
          ...
          className="flex-[1] px-3 py-2 bg-slate-900 border border-slate-800 hover:bg-slate-800 rounded-lg text-[11px] font-semibold text-indigo-400 transition-colors flex items-center justify-center gap-1.5"
        >
